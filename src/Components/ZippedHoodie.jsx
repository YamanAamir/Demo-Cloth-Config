...
const ZippedHoodie = ({ data, onUpdate, isAppReady, loadedTrigger, logos, backDesigns, onOpenInquiry, activeTab: externalTab, onTabChange, maxCharsText = 25, libDesignColor: libDesignColorProp, setLibDesignColor }) => {
  ...
  useEffect(() => {
    ...
    postIfChanged("size", `ZipperHoodie:size:${selectedSize}`);
    ...
    if (update.canvasBase64) {
      ...
      if (color === 'black' && opacityB64) {
        ...
        img.onload = () => {
          ...
          postToActivePreview("ZipperHoodie:back_white_diffuse: " + cleanDiffuseB64);
        ...
        img.onload = () => {
          ...
          postToActivePreview("ZipperHoodie:back_black_diffuse: " + cleanDiffuseB64);
          postToActivePreview("ZipperHoodie:back_black_opacity: " + opacityB64);
        };
        img.src = opacityB64;
      }
    }
